...
//   async function onSubmitEdit(id: string, values: z.infer<typeof roleSchema>) {
//     console.log(values);
//   }
...
//     if (idEdit) {
//       await onSubmitEdit(idEdit, values)
//     } else {
...
//               <FormControl>
//                 <Input placeholder="trabajador ..." {...field} value={data ? data.role : ''}/>
//               </FormControl>
...
//               <FormControl>
//                 <Input placeholder="acceso a modulos ..." {...field} value={data ? data.description : ''}/>
//               </FormControl>
//               <FormMessage className="text-end" />
//             </FormItem>
//           )}
