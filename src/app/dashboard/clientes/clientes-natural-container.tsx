    ...
    <>
      ...
      <div className="flex justify-between gap-4">
        <DialogForm
          ...
          open={open}
          setOpen={setOpen}
          textButton="Agregar persona natural"
          titleDialog="Cliente nuevo (Persona natural)"
          descriptionDialog="Agrega un cliente nuevo">
          <FormClientePersonaNatural
            setOpen={setOpen}
            idEdit={itemEditing?.id}
            data={{
              firstName: itemEditing?.firstName,
              lastName: itemEditing?.lastName,
              identifier: itemEditing?.identifier,
